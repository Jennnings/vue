    ...
    <div>
      <a-spin :spinning="spinning">
        ...
        <div class="buttonGtoup">
          ...
          <div class="singlebutton">
            <a-button type="primary" @click="confirmProjectCopy">
              确认
            </a-button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getcreateTime(date, dateString) {
      ...
      console.log(this.params.clientDate);
    },
    //项目更新 更新希望进场时间
    ...
    confirmProjectCopy() {
      ...
      this.postParams.append("projectClient", this.params.clientName); // 委托单位名称
      this.postParams.append("createTime", this.params.clientDate); // 委托时间
      this.postParams.append("clientAddress", this.params.clientAddress); // 委托单位地址
      this.postParams.append("client", this.params.clientPeople); // 委托人
      this.postParams.append("clientTelephone", this.params.clientPeopleTel); // 委托人电话
      this.postParams.append("contactPerson", this.params.contactPeople); // 联系人
      this.postParams.append("contactTelephone", this.params.contactPeopleTel); // 联系人电话
      ...
      this.postParams.append("agentConstruction", this.params.djUnit); // 代建单位名称
      this.postParams.append(
        "projectTypeChecked",
        this.params.projectTypeChecked
      ); // 项目类型
      this.postParams.append("sceneLocation", this.params.projectAddress); // 现场坐落
      this.postParams.append("hopeToEnterTime", this.params.approachTime); // 希望进场时间
      this.postParams.append("otherRequirement", this.params.otherInfo); // 其他要求
      this.postParams.append("otherMaterial", this.params.otherMaterial); // 其他资料清单
      this.postParams.append(
        "DjmanUserID",
